...
import com.sofka.shop.handdle.model.ErrorResponse;
...
public class ErrorHandler {
    ...
    Mono<ServerResponse> badRequest(Throwable error) { return response.apply(HttpStatus.BAD_REQUEST, error.getMessage()); }
